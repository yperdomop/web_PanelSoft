    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand " href="#page-top">
                    <img src="{{asset('img/logo.svg')}}" width="60" height="60" alt="">
                    PanelSoft
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#contactenos">Contáctenos</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <section class="page-section bg-primary text-white mb-0" id="nosotros">
            <div class="container">
                ...
                <div class="row">
                    <div class="col ms-auto"><p class="lead">
                        Somos un grupo de profesionales que te ayudamos al desarrollo y crecimiento de tu empresa, aplicando las nuevas tecnologia de información y comunicación (TIC). Nuestro principal propósito es implementar las diferentes herramientas tecnológicas que ayuden y faciliten los diferentes procesos que hay dentro de la organización!</p></div>
                </div>
        ...
        <section class="page-section" id="contactenos">
            <div class="container">
                ...
                <div class="divider-custom">
                    ...
                    <div class="divider-custom-icon"><i class="fab fa-whatsapp"></i></div>
                    <div class="divider-custom-line"></div>
                </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright &copy; PanelSoft 2022</small></div>
        </div>
        <!-- Portfolio Modals-->
        <!-- Portfolio Modal 1-->
